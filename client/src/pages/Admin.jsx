    ...
    <Container>
      ...
      <TabPanel value={tabValue} index={0} >
        ...
        <Box style={{display: 'flex' , gap: '20px', flexDirection: 'column'}}>
          ...
          onChange={(e) => setFamilyMemberData({ ...familyMemberData, name: e.target.value })}
        />
        <TextField
          label="Age"
          variant="outlined"
          ...
          onChange={(e) => setFamilyMemberData({ ...familyMemberData, age: e.target.value })}
        />
        <TextField
          label="Status"
          variant="outlined"
          value={familyMemberData.status}
          onChange={(e) => setFamilyMemberData({ ...familyMemberData, status: e.target.value })}
        />
      ...
      <TabPanel value={tabValue} index={1} >
        ...
        <TextField
          ...
          onChange={(e) => setMedicineData({ ...medicineData, expirationDate: e.target.value })}
        />
        </Box>
        <TextField
          label="Cost"
          ...
          onChange={(e) => setMedicineData({ ...medicineData, cost: e.target.value })}
        />
      ...
      <TabPanel value={tabValue} index={2}>
        ...
        <Box style={{ display: 'flex', gap: '20px', flexDirection: 'column' }}>
            ...
            onChange={(e) => setIllnessData({ ...illnessData, diagnosis: e.target.value })}
            />
            <TextField
            label="Reason for Medications"
            variant="outlined"
            value={illnessData.reason_for_medications}
            onChange={(e) => setIllnessData({ ...illnessData, reason_for_medications: e.target.value })}
            />
            <Box>
            <InputLabel htmlFor="expiration-date" sx={{fontSize:'14px'}}>Start of Illnes</InputLabel>
            <TextField
            variant="outlined"
            type="date"  
            value={illnessData.period_of_illness}
            onChange={(e) => setIllnessData({ ...illnessData, period_of_illness: e.target.value })}
            />
            </Box>
            <TextField
            select
            ...
            onChange={(e) => setIllnessData({ ...illnessData, prescribed_by: e.target.value })}
            >
            ...
            onChange={(e) => setIllnessData({ ...illnessData, result: e.target.value })}
            >
            ...
            onChange={(e) => setIllnessData({ ...illnessData, note: e.target.value })}
            />
      ...
      <TabPanel value={tabValue} index={3}>
        ...
        <Button variant="contained" color="primary" onClick={handleAddMedicineUsage}>
           Add Medicine Usage
        </Button>
        </Box>
      </TabPanel>
      <TabPanel value={tabValue} index={4}>
        ...
        <TextField
          ...
          onChange={(e) => setPurchaseData({ ...purchaseData, medicines: [{ MedicineId: e.target.value, quantity: 0 }] })}
        />
